...
fig.update_layout(title=dict(text=f'<b>Revolução Planetária {ano}: {planeta_selecionado} em {signo_selecionado} {grau_input}°</b>', x=0.5, xanchor = 'center', font = dict(size = 20)),
                  height=700,
